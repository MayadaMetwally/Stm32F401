...
const SWITCH_tstr SWITCH[_NUM_SWITCH]={
		[SWITCH_01]={.PORT=GPIOA,.PIN=GPIO_PIN_3,.MODE=GPIO_MODE_IN_PU},
		[SWITCH_02]={.PORT=GPIOA,.PIN=GPIO_PIN_4,.MODE=GPIO_MODE_IN_PU},
		[SWITCH_03]={.PORT=GPIOA,.PIN=GPIO_PIN_5,.MODE=GPIO_MODE_IN_PU},
